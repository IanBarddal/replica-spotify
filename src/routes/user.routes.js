...
import { getCurrentUser, getCurrentUserLikedTracks, getCurrentUserPlaylists, getCurrentUserRecentlyPlayedTracks, getCurrentUserTopArtists, 
...
router.get("/me/tracks", getCurrentUserLikedTracks)
